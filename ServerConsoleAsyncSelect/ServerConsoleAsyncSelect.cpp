// ServerConsoleAsyncSelect.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "ServerConsoleAsyncSelect.h"
#include<winsock.h>
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_SERVERCONSOLEASYNCSELECT, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SERVERCONSOLEASYNCSELECT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SERVERCONSOLEASYNCSELECT));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_SERVERCONSOLEASYNCSELECT);
